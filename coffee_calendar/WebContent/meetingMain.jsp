    ...
    <div class="meeting_filters"><!-- meeting_filters start-->
        ...
        <div class="meeting_content"><!--meeting_content start-->
            ...
            <%for(Meeting meeting:meetings){ %>
        			...
        			<a href=""><img src="/img/<%=meeting.getImg()%>" width="267" height="160" alt="밋팅커버"/></a>
        		...
        		<ul class="meeting_info">
            		...
            		<li class="meeting_name"><span><%=meeting.getName()%></span> <img src="/img/fighting.png" width="20" height="20"/></li>
	...
	<script type="text/template" id="meetingListByThemeNoTmpl">
    	...
    	<li class="meeting_list_each">
        	...
        	<ul class="meeting_info">
            	...
            	<li class="meeting_name"><span><@=meeting.name@></span> <img src="/img/fighting.png" width="20" height="20"/></li>
