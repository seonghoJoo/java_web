...
<div id="container"><!-- container start-->
    <div class="category_box"><!-- category_box start -->
        <ul class="category_list"><!-- category_list start -->
            <li><a href=""><i class="fas fa-gamepad"></i><p>게임</p></a></li>
            <li><a href=""><i class="fas fa-pallet"></i><p>문화/예술</p></a></li>
            <li><a href=""><i class="fas fa-dog"></i><p>반려동물</p></a></li>
            <li><a href=""><i class="fas fa-people-carry"></i><p>봉사활동</p></a></li>
            <li><a href=""><i class="fas fa-users"></i><p>사교모임</p></a></li>
            <li><a href=""><i class="fas fa-book-open"></i><p>스터디</p></a></li>
            <li><a href=""><i class="fas fa-futbol"></i><p>스포츠/레저</p></a></li>
            <li><a href=""><i class="fas fa-guitar"></i><p>음악/악기</p></a></li>
            <li><a href=""><i class="fas fa-campground"></i><p>아웃도어</p></a></li>
    ...
    <div id="content"><!-- content start-->
        <div class="crews_with_upcoming_meeting_box"><!--crews_with_upcoming_meeting_box start -->
            ...
            <div class="upcoming_meeting_list_box"><!--upcoming_meeting_list_box start-->
                ...
                for(Gathering gathering:gatherings){
                	...
                	%>
                    <li class="upcoming_meeting_item"><p><%=whichDay%></p><a href=""><img src="/img/crew/<%=gathering.getCrewCoverImg()%>"/>
        ...
        <div class="crews_recruiting_new_members_wrap"><!-- crews_recruiting_new_members_wrap start-->
            <div class="crews_recruiting_new_members_top"><!-- crews_recruiting_new_members_top start-->
                ...
                <a href=""><h3 class="see_more_btn">더보기</h3></a>
            ...
            <div class="crews_recruiting_new_members_box"><!-- crews_recruiting_new_members_box start-->
                ...
                <%int j=1; for(Crew crew:crews){ System.out.println(crew);%>
                    <li class="crews_recruiting_new_members_item"><a href=""><img src="/img/crew/<%=crew.getCoverImg()%>" width="247.5" height="180"/>
