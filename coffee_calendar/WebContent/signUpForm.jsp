...
<%@ include file="/WEB-INF/template/header.jsp"%>
    ...
    <div id="content"><!-- content -->
        ...
        <div class="sign_up_list">
            ...
            <div class="sign_up_item"><div class="sign_up_circle"><i class="fas fa-id-badge"></i></div><p class="sign_up_subtitle">이메일 인증</p></div>
        </div><!--//상단 진행 상태-->
...
<script>
    ...
    function checkPhoneNumber(str) {
        var reg_pwd =  /^[A-Za-z0-9]{6,12}$/;//숫자와 문자 포함 형태의 6~12자리 이내의 암호 정규식
        if(!reg_pwd.test(str)){
            return false;
        }else {
            return true;
    ...
    //sign in form input 요소 비워져 있을 때 서브밋 버튼 클릭하면 비워진 input 요소 색깔 변하도록
