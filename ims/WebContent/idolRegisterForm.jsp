	...
	<form action="/idolRegister.jsp" method="post" enctype="multipart/form-data">
		<fieldset>
			...
			<p>
				<label>
				 이름
				 <input name="name" placeholder="아이돌 이름"/>
				</label>
			</p>
			<p>
				<label>
			...
			<p>
				...
				<input type="radio" id="male" name="gender" value="M"><label for="male"><i class="fas fa-male"></i>  남자</label>
				<input type="radio" id="female" name="gender" checked value="F" ><label for="female"><i class="fas fa-female"></i>  여자</label>
			<p>
				<strong> 생년년월일</strong>
				<select name="year">
