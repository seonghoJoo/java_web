...
public class MeetingRequestList extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for(WaitingMeetingCrewsJson s : watingMeetingCrews) {
			System.out.println("no: "+s.getNo());
			System.out.println("meetingNo: "+s.getMeetingNo());
			System.out.println("applyCrewNo: "+s.getApplyCrewNo());
			System.out.println("introduce: "+s.getIntroduce());
			System.out.println("crewCcoverImg: "+s.getCrewCoverImg());
			System.out.println("crewName: "+s.getCrewName());
			System.out.println("meetingName: "+s.getMeetingName());
			System.out.println("startDate: "+s.getStartDate());
			System.out.println("regdate: "+s.getRegdate());
		}
		//json 생성
