            ...
            <div class="header_crew_list"><!--header_crew_list-->
                <ul>
                	<%for(int i=0;i<userCrews.length;i++){ %>
                		<%if(userCrews[i]!=null){ %>
                    		<li><a href="/crewDetailPost.jsp?crewNo=<%=userCrews[i].getNo()%>&userCrews=<%=i%>"><img class="header_crew_list_on" src="/img/<%=userCrews[i].getCoverImg() %>" width="40" height="40" /></a></li>
                   		<%}else{ %>
