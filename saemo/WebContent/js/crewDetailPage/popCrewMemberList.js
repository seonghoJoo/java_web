    ...
    success:function(json) {
		_.each(json,function(j){
           ...
           if(j.rank=='O') {
                ...
                $memberItem = $memberItem.append($memberImg, $memberName, $mark, managementOperatorBox, $declarationBox);
            ...
            if(j.rank=='M') {
                ...
                $memberItem = $memberItem.append($memberImg, $memberName ,$managementMemberBox, $declarationBox);
