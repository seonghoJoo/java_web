...
function getPassFlag(stepNumber){
    switch(stepNumber){
        // case 1: return passFlag1_step1*passFlag2_step1*passFlag3_step1*passFlag4_step1;
        case 1: return 1;
        case 2: return 1;
        // case 2: if($("#sample5_address").val()==""){return 0;}else{return 1;}
        case 3: return 1;
        // case 3: return passFlag1_step3*passFlag2_step3*passFlag3_step3;
        case 4: return 1;
        case 5: return 1;
    }
}
...
let passFlag3_step1 = 0;
let passFlag4_step1 = 0;
...
$("#meetingImageInput").on("change",function() {
    ...
    $.ajax({
        ...
        success:function(json) {
            $(".meeting_image").css("background-image","url(/profile/"+json.imageName+")");
...
$nextBtn.click(function(){
	if($(this).parent().hasClass("meetingMakingStep5")){
		$comfirmMeetingImg.attr("src", "/profile/"+imgTemp);
